# CELINE Ontology v0.9

**Namespace**: `https://w3id.org/celine-eu#`
**IRI**: `https://w3id.org/celine-eu`
**Version IRI**: `https://w3id.org/celine-eu/v0.9`

Conformance fix over v0.8. The `cim:` prefix was bound to TNO's hosting URL rather than the
IEC CIM namespace, so every `skos:closeMatch` alignment to CIM resolved to a term that does
not exist. No new terms; no term is removed or retyped.
